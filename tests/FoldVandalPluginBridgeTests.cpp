...
public:
    ...
    foldvandal::plugin::FoldVandalPlugin plugin;
...
void testParameterResponse()
{
    ...
    softParameters[0]->setValue (0.05f);
    ...
    hardParameters[0]->setValue (1.0f);
...
void testStateRoundTrip()
{
    ...
    sourceParameters[3]->setValue (0.71f);
    ...
    assert (std::fabs (targetParameters[3]->getValue() - 0.71f) <= 1.0e-6f);
}
...
int main()
{
    ...
    std::cout << "FoldVandalPluginBridgeTests passed\n";
    return 0;
}
